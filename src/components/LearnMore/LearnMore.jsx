  ...
  return (
    <div className="opacity-0 aboutDiv absolute h-full bg-slate-900 text-gray-200 w-full top-0 transition-opacity duration-500 flex flex-col items-center justify-center space-y-5">
      ...
      <NavLink
        ...
        className="learnMoreBtn hidden border-2 cursor-pointer px-4 py-2 font-extralight border-pink-600  hover:bg-transparent hover:bg-pink-600 hover:text-zinc-50 hover:transition-colors hover:duration-500 xsm:text-xl md:text-base lg:text-xl"
      >
        Learn more
      </NavLink>
    </div>

...
const PortfolioSection = () => {
  try {
    ...
    const { title, intro, learning, technologies, nexttime, git, site, role } =
      sectionData;
    return (
      <div className=" bg-zinc-50 fixed top-0 w-full max-w-fit p-6 right-0 left-0 mx-auto leading-6 text-slate-600 font-light z-20 overflow-y-auto h-full flex flex-col justify-center">

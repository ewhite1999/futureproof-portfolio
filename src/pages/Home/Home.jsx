  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-slate-900 text-gray-200 font-light space-y-4 sm:space-y-8 2xl:font-normal">
      ...
      <Link
        ...
        smooth={true}
        duration={800}
        className="border-2 cursor-pointer px-4 py-2 font-extralight hover:bg-transparent hover:bg-pink-600 hover:border-pink-600 hover:transition-colors hover:duration-500 sm:text-xl 2xl:text-2xl"
      >
        See my Portfolio
      </Link>
    </section>
